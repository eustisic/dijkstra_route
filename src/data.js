export const getAirlineById = (id) => {
  //search airlines array and return the name of the airline with a matching id
return (
    airlines.find(line => line.id === id)
  )
}

export const getAirportByCode = (code) => {
// given a code find the name of the associated airport
  return (
    airports.find(port => port.code === code)
  )
}
...
export default {routes, airlines, airports, R};